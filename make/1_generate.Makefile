...
__VOODOO_MULTI_EXECUTABLE = $(__VOODOO_ENVIRONMENT) $(PYTHON_EXECUTABLE) '$(VOODOO_ROOT_DIR)/voodoo/multi.py'
...
__VOODOO_SINGLE_EXECUTABLE = $(__VOODOO_ENVIRONMENT) $(PYTHON_EXECUTABLE) '$(VOODOO_ROOT_DIR)/voodoo/single.py'
...
$(UNITTEST_BUILD_DIRECTORY)/%.cxx:
	-$(Q)mkdir --parents $(@D)
	@echo 'CXXTSTGN' $@
	$(Q)$(PYTHON_EXECUTABLE) $(VOODOO_ROOT_DIR)/cxxtest/simplecxxtestgen.py --output=$@ --input=$<
